<?php require 'header.php'; ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-item nav-link active" href="euratech.php">Euratech</a>
            <a class="nav-item nav-link" href="DigitalEnvironment.php">Digital Environment</a>
            <a class="nav-item nav-link" href="formContact.php">Contact us</a>
            </div>
        </div>
    </nav>
...
<div>
    ...
    Préfixe : <strong>W.I.L.D.</strong><br />
    Nom de la Société :<strong> W.I.L.D.</strong><br />
    Adresse : <strong>Euratechnologie 59000 Lille</strong><br />
    Tél  : <strong>032098990012</strong><br />
    Au Capital de :<strong> 1000 0000 €</strong><br />
    SIRET :  <strong>FEUHIFDZJODZ22   </strong>R.C.S. :<strong> DFE</strong><br />
    Numéro TVA intracommunautaire : <strong>EZDZ</strong><br />
    Adresse de courrier électronique : <strong>l.allard@yahoo.fr</strong> <br />
    <br />
    Le Créateur du site est : <strong>Groupe FIVE</strong><br />
    Le Responsable de la  publication est : <strong>GROUPE FIVE</strong><br />
    Contactez le responsable de la publication : <strong>l.allard@yahoo.fr</strong><br />
    Le responsable de la publication est une <strong>personne physique</strong><br />
    <br />
    Le Webmaster est  : <strong>groupe5</strong><br />
    Contactez le Webmaster : <strong><a href="mailto:l.allard@yahoo.fr?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.localhost.com">l.allard@yahoo.fr</a></strong><br />
    L’hebergeur du site est : <strong>euratech WCS 59000 Lille</strong><br />
    ...
    <br />
    Le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> a pour objet de fournir une information concernant l’ensemble des activités de la société.<br />
    Le proprietaire du site s’efforce de fournir sur le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> des informations aussi précises que possible. Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.<br />
    Tous les informations proposées sur le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> sont données à titre indicatif, sont non exhaustives, et sont susceptibles d’évoluer. Elles sont données sous réserve de modifications ayant été apportées depuis leur mise en ligne.<br />
    </p>
    ...
    Toute reproduction, représentation, modification, publication, adaptation totale ou partielle des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable à l'email : <a href="mailto:l.allard@yahoo.fr?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.localhost.com"><strong>l.allard@yahoo.fr</strong></a> .<br />
    ...
    <br />
    Le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> contient un certain nombre de liens hypertextes vers d’autres sites (partenaires, informations …) mis en place avec l’autorisation de le proprietaire du site . Cependant, le proprietaire du site n’a pas la possibilité de vérifier le contenu des sites ainsi visités  et décline donc toute responsabilité de ce fait quand aux risques éventuels de contenus illicites.<br />
    <br />
    L’utilisateur est informé que lors de ses visites sur le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a>, un ou des cookies sont susceptible de s’installer automatiquement sur son ordinateur. Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.<br />
    <br />
    ...
    <br />
    Utilisateur : Internaute se connectant, utilisant le site susnommé : <a href="http://www.localhost.com" target="_blank">www.localhost.com</a><br />
    ...
    <p style="text-align:justify">Sur le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a>, le proprietaire du site ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a>. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> l’obligation ou non de fournir ces informations.<br />
    Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification, de suppression et d’opposition aux données personnelles le concernant. Pour l’exercer, adressez votre demande à <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> par email : email du webmaster ou  en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.</p>
    <p style="text-align:justify">Aucune information personnelle de l'utilisateur du site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat du site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a> à le proprietaire du site et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site <a href="http://www.localhost.com" target="_blank">www.localhost.com</a>.</p>
    <p style="text-align:justify">Le site www.localhost.com est en conformité avec le RGPD voir notre politique RGPD  https://editioneo.com/formalites/declaration-cnil?utm_medium=partner&utm_source=generer_mentions_legales&utm_campaign=declaration_cnil.</p>
